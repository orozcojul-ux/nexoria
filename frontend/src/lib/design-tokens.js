...
export const TOKENS = {
  ...
  glowVioletSoft: "0 0 16px rgba(138,43,226,0.35)",
  glowVioletStrong: "0 0 30px rgba(138,43,226,0.55), inset 0 0 12px rgba(138,43,226,0.25)",
...
export const RARITY = {
  ...
  rare:     { fr: "Rare",       color: "#22C55E", glow: "rgba(34,197,94,0.6)",   bg: "from-green-700/30 to-green-900/30",       border: "border-green-400/60", text: "text-green-300" },
...
export const SECTION_TONE = {
  ...
  violet:  { color: "#8A2BE2", border: "border-purple-500/40", bg: "bg-purple-500/10", text: "text-purple-300" },
