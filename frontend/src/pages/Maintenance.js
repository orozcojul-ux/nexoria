...
export default function Maintenance() {
  ...
  return (
    <div className="maintenance-page" data-testid="maintenance-page">
      ...
      <motion.aside
        className="maint-discord-aside"
        initial={{ opacity: 0, x: 30 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ delay: 0.5, duration: 0.6 }}
        data-testid="maintenance-discord-aside"
      >
        <div className="maint-discord-aside-glow" aria-hidden />
        <svg viewBox="0 0 24 24" className="maint-discord-aside-icon" fill="currentColor" aria-hidden>
        ...
        <p className="maint-discord-aside-kicker">En attendant l'ouverture des portails</p>
        <p className="maint-discord-aside-title">Retrouve le Nexus sur Discord</p>
        <p className="maint-discord-aside-body">
          Suis l'avancée des travaux en direct, discute avec les autres héros et reçois ta clé
          d'accès anticipé dès que le royaume rouvre ses portes.
        </p>
        <a
          href={DISCORD_URL}
          target="_blank"
          rel="noopener noreferrer"
          className="maint-discord-aside-btn"
          data-testid="maintenance-discord-aside-btn"
        >
