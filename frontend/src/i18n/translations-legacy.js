/** Legacy inline keys — merged first; later modules override. */
export const TRANSLATIONS_LEGACY = {
  ...
  "settings.country": { fr: "Pays / région", en: "Country / region", es: "País / región", de: "Land / Region", it: "Paese / regione", pt: "País / região", nl: "Land / regio", ja: "国 / 地域" },
  "settings.country.changed": { fr: "Pays mis à jour", en: "Country updated", es: "País actualizado", de: "Land aktualisiert", it: "Paese aggiornato", pt: "País atualizado", nl: "Land bijgewerkt", ja: "国を更新しました" },
  "settings.country.cleared": { fr: "Pays retiré", en: "Country removed", es: "País eliminado", de: "Land entfernt", it: "Paese rimosso", pt: "País removido", nl: "Land verwijderd", ja: "国を削除しました" },
  "settings.country.clear": { fr: "Retirer le pays", en: "Remove country", es: "Quitar país", de: "Land entfernen", it: "Rimuovi paese", pt: "Remover país", nl: "Land verwijderen", ja: "国を削除" },
  "settings.country.discordHint": { fr: "Synchronisé avec votre rôle pays sur Discord. Vous pouvez aussi le modifier ici — le changement sera reflété sur Discord si votre compte est lié.", en: "Synced with your country role on Discord. You can also change it here — it will update Discord if your account is linked.", es: "Sincronizado con tu rol de país en Discord. También puedes cambiarlo aquí si tu cuenta está vinculada.", de: "Mit deiner Discord-Länderrolle synchronisiert. Du kannst es hier ändern — bei verknüpftem Konto wird Discord aktualisiert.", it: "Sincronizzato con il ruolo paese su Discord. Puoi modificarlo anche qui se l'account è collegato.", pt: "Sincronizado com seu cargo de país no Discord. Você também pode alterar aqui se a conta estiver vinculada.", nl: "Gesynchroniseerd met je landrol op Discord. Je kunt het hier ook wijzigen als je account gekoppeld is.", ja: "Discordの国ロールと同期しています。アカウント連携時はここから変更できます。" },
  "settings.preferences.saved": { fr: "Préférences enregistrées.", en: "Preferences saved.", es: "Preferencias guardadas.", de: "Einstellungen gespeichert.", it: "Preferenze salvate.", pt: "Preferências salvas.", nl: "Voorkeuren opgeslagen.", ja: "設定を保存しました。" },
  "settings.preferences.discordSynced": { fr: "Préférences enregistrées. Rôles Discord synchronisés.", en: "Preferences saved. Discord roles synced.", es: "Preferencias guardadas. Roles de Discord sincronizados.", de: "Einstellungen gespeichert. Discord-Rollen synchronisiert.", it: "Preferenze salvate. Ruoli Discord sincronizzati.", pt: "Preferências salvas. Cargos do Discord sincronizados.", nl: "Voorkeuren opgeslagen. Discord-rollen gesynchroniseerd.", ja: "設定を保存し、Discordロールを同期しました。" },
  "settings.preferences.discordNotLinked": { fr: "Préférences enregistrées. Lie ton compte Discord pour synchroniser tes rôles.", en: "Preferences saved. Link your Discord account to sync your roles.", es: "Preferencias guardadas. Vincula tu cuenta de Discord para sincronizar tus roles.", de: "Einstellungen gespeichert. Verknüpfe dein Discord-Konto, um Rollen zu synchronisieren.", it: "Preferenze salvate. Collega il tuo account Discord per sincronizzare i ruoli.", pt: "Preferências salvas. Vincule sua conta Discord para sincronizar os cargos.", nl: "Voorkeuren opgeslagen. Koppel je Discord-account om rollen te synchroniseren.", ja: "設定を保存しました。Discordアカウントを連携するとロールが同期されます。" },
  "settings.preferences.discordFailed": { fr: "Préférences enregistrées, mais la synchronisation Discord a échoué.", en: "Preferences saved, but Discord sync failed.", es: "Preferencias guardadas, pero falló la sincronización con Discord.", de: "Einstellungen gespeichert, aber Discord-Sync fehlgeschlagen.", it: "Preferenze salvate, ma sincronizzazione Discord non riuscita.", pt: "Preferências salvas, mas a sincronização com o Discord falhou.", nl: "Voorkeuren opgeslagen, maar Discord-sync mislukt.", ja: "設定は保存されましたが、Discord同期に失敗しました。" },
  "country.fr": { fr: "France", en: "France", es: "Francia", de: "Frankreich", it: "Francia", pt: "França", nl: "Frankrijk", ja: "フランス" },
  "country.be": { fr: "Belgique", en: "Belgium", es: "Bélgica", de: "Belgien", it: "Belgio", pt: "Bélgica", nl: "België", ja: "ベルギー" },
  "country.ch": { fr: "Suisse", en: "Switzerland", es: "Suiza", de: "Schweiz", it: "Svizzera", pt: "Suíça", nl: "Zwitserland", ja: "スイス" },
  "country.ca": { fr: "Canada", en: "Canada", es: "Canadá", de: "Kanada", it: "Canada", pt: "Canadá", nl: "Canada", ja: "カナダ" },
  "country.us": { fr: "États-Unis", en: "United States", es: "Estados Unidos", de: "USA", it: "Stati Uniti", pt: "Estados Unidos", nl: "Verenigde Staten", ja: "アメリカ" },
  "country.uk": { fr: "Royaume-Uni", en: "United Kingdom", es: "Reino Unido", de: "Vereinigtes Königreich", it: "Regno Unito", pt: "Reino Unido", nl: "Verenigd Koninkrijk", ja: "イギリス" },
  "country.es": { fr: "Espagne", en: "Spain", es: "España", de: "Spanien", it: "Spagna", pt: "Espanha", nl: "Spanje", ja: "スペイン" },
  "country.de": { fr: "Allemagne", en: "Germany", es: "Alemania", de: "Deutschland", it: "Germania", pt: "Alemanha", nl: "Duitsland", ja: "ドイツ" },
  "country.it": { fr: "Italie", en: "Italy", es: "Italia", de: "Italien", it: "Italia", pt: "Itália", nl: "Italië", ja: "イタリア" },
  "country.br": { fr: "Brésil", en: "Brazil", es: "Brasil", de: "Brasilien", it: "Brasile", pt: "Brasil", nl: "Brazilië", ja: "ブラジル" },
  "country.nl": { fr: "Pays-Bas", en: "Netherlands", es: "Países Bajos", de: "Niederlande", it: "Paesi Bassi", pt: "Países Baixos", nl: "Nederland", ja: "オランダ" },
  "country.jp": { fr: "Japon", en: "Japan", es: "Japón", de: "Japan", it: "Giappone", pt: "Japão", nl: "Japan", ja: "日本" },
  "country.other": { fr: "Autre", en: "Other", es: "Otro", de: "Andere", it: "Altro", pt: "Outro", nl: "Overig", ja: "その他" },
  ...
  "landing.subtitle": { fr: "Une plateforme MMORPG sociale premium. Choisis ta classe, rejoins une guilde, explore les 4 sanctuaires du Nexus et grave ta légende dans le cosmos.", en: "A premium social MMORPG platform. Choose your class, join a guild, explore 4 Nexus sanctuaries and carve your legend in the cosmos.", es: "Una plataforma MMORPG social premium. Elige tu clase, únete a un gremio y explora el Nexus.", de: "Eine Premium-Social-MMORPG-Plattform. Wähle deine Klasse und erkunde den Nexus.", it: "Una piattaforma MMORPG sociale premium. Scegli la tua classe ed esplora il Nexus.", pt: "Uma plataforma MMORPG social premium. Escolha sua classe e explore o Nexus.", nl: "Een premium sociaal MMORPG-platform. Kies je klasse en verken de Nexus.", ja: "プレミアムソーシャルMMORPG。クラスを選び、ギルドに参加し、ネクサスの4つの聖域を探索しよう。" },
