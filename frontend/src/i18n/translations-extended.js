...
export const TRANSLATIONS_EXTENDED = {
  ...
  "page.shop.title": T("Boutique d'Aether", "Aether Shop"),
  ...
  "page.quests.subtitle": T("Accomplis tes objectifs et récolte XP et Aether.", "Complete objectives and earn XP and Aether."),
  ...
  "page.kingdom.subtitle": T("{aether} Aether disponibles pour ennoblir vos édifices.", "{aether} Aether available to upgrade your buildings."),
