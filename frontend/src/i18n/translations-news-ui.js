...
export const TRANSLATIONS_NEWS_UI = {
  ...
  "report.reason.insult": T("Insulte", "Insult", { es: "Insulto", de: "Beleidigung", it: "Insulto", pt: "Insulto", nl: "Belediging", ja: "侮辱" }),
  ...
  "report.reason.suspicious_link": T("Lien suspect", "Suspicious link", { es: "Enlace sospechoso", de: "Verdächtiger Link", it: "Link sospetto", pt: "Link suspeito", nl: "Verdachte link", ja: "不審なリンク" }),
