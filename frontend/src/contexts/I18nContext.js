...
const TR = {
  ...
  "legend.aether.body": {
    ...
    it: "L'Etere è la moneta reale. Guadagnalo con missioni, eventi e ricompense stagionali.\nSpendilo nel negozio o nel regno.\nIl saldo si aggiorna in tempo reale.",
    pt: "O Éter é a moeda real. Ganhe com missões, eventos e recompensas de temporada.\nGaste na loja ou no reino.\nSeu saldo atualiza em tempo real.",
    nl: "Aether is de koninklijke munt. Verdien het via quests, events en seizoensbeloningen.\nBesteed het in de winkel of het koninkrijk.\nJe saldo wordt live bijgewerkt.",
    ja: "エーテルは王国の通貨です。残高はリアルタイムで更新されます。",
  },
