/** Logo Discord flottant — même style que Layout */
export default function DiscordFab({ className = "", testid = "discord-floating-btn" }) {
  ...
  return (
    <a
      ...
      data-testid={testid}
      className={`fixed z-40 w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 transition-transform ${className}`}
      style={{ background: "linear-gradient(135deg, #5865F2, #404EED)", boxShadow: "0 6px 24px rgba(88,101,242,0.5)" }}
      title="Discord NEXORIA"
    >
